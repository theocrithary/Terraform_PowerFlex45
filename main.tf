...
resource "vsphere_virtual_machine" "powerflex-node-1" {
  ...
  clone {
    ...
    customize {
      ...
      network_interface {
        ipv4_address = var.powerflex_node_1_rep_ip
        ipv4_netmask = var.subnet_netmask
      }
      ipv4_gateway = var.subnet_gateway
      dns_server_list = [var.dns_server_list]
...
resource "vsphere_virtual_machine" "powerflex-node-2" {
  ...
  clone {
    ...
    customize {
      ...
      network_interface {
        ipv4_address = var.powerflex_node_2_rep_ip
        ipv4_netmask = var.subnet_netmask
      }
      ipv4_gateway = var.subnet_gateway
      dns_server_list = [var.dns_server_list]
...
resource "vsphere_virtual_machine" "powerflex-node-3" {
  ...
  clone {
    ...
    customize {
      ...
      network_interface {
        ipv4_address = var.powerflex_node_3_rep_ip
        ipv4_netmask = var.subnet_netmask
      }
      ipv4_gateway = var.subnet_gateway
      dns_server_list = [var.dns_server_list]
...
resource "vsphere_virtual_machine" "powerflex-node-4" {
  ...
  clone {
    ...
    customize {
      ...
      network_interface {
        ipv4_address = var.powerflex_node_4_rep_ip
        ipv4_netmask = var.subnet_netmask
      }
      ipv4_gateway = var.subnet_gateway
      dns_server_list = [var.dns_server_list]
